...
public class CalcularModelo {
	...
	public void calcular() {
		...
		try {
			...
			// guardar el modelo 
			BufferedOutputStream modelOut = new BufferedOutputStream(new FileOutputStream("model"+File.separator+"datostesis.bin"));
			model.serialize(modelOut);
			ClassicNLP.setMensaje("\nArchivo con el modelo : "+"model"+File.separator+"datostesis.bin");
/* 
